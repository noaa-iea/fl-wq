...
if (length(unique(d$lon_dd)) > 1){
  section_plot(
    ...
    zscale = "gradient2", midpoint = mean(df$chl_mgL), 
    low = "white", mid = "lightgreen", high = "darkgreen",
...
section_plot(
  ...
  # zscale = "plasma",
  zscale = "gradient2", midpoint = mean(df$o2_mgL), 
  low = "red", mid = "black", high = "gray90",
  bottom = "bdepth_ft", sampling_indicator = "points",
  interpolate  = T, contour = contours, contour_color = "gray")
```
